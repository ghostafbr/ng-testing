...
describe('MapsService', () => {
  ...
  /*describe('test for getCurrentPosition', () => {
    it('should save the center', async () => {
      // Arrange
      const geolocationSpy = jest.spyOn(navigator.geolocation, 'getCurrentPosition').mockImplementation((successFn) => {
      ...
      // Restaurar la implementación original de getCurrentPosition
